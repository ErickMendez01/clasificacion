...
const Header = () => {
  ...
  return (
    <div>
      <DiagnosticForm isOpen={isOpen} onOpenChange={onOpenChange} />
        ...
        <div className="relative pt-36 px-4 sm:px-6 lg:px-8">
          <div className="lg:w-2/3 mx-auto text-center">
            <h1 className="text-gray-900 dark:text-white font-bold text-4xl sm:text-5xl md:text-6xl xl:text-7xl">
              Clasifica a tus pacientes en{" "}
              <span className="text-primary dark:text-white">
                Clínica Mental
              </span>
            </h1>
            <p className="mt-6 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              La plataforma integral para profesionales de la salud mental y
              usuarios no especializados. Clasifica los riesgos de la depresión
              automáticamente mediante tecnología avanzada de árboles de
              decisión.
            </p>
